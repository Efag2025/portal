...
function aplicarMedidaDisciplinar() {
  const nome = document.getElementById("nomeAlunoDisciplina").value.trim();
  ...
  if (!nome || !faltaEl) {
    alert("⚠️ Preencha o nome do aluno e selecione uma infração.");
    return;
  }
  ...
  document.getElementById("nomeAlunoDisciplina").value = "";
  faltaEl.remove();
